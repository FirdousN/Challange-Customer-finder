...
export default function LoginForm({ role }: LoginFormProps) {
  ...
  const title = role === "ADMIN" ? "Admin Login" : "Staff Login";
  const redirectPath = isAdmin ? "/admin" : "/staff/scanner";
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-zinc-50 dark:bg-black gap-64 py-12 px-4 sm:px-6 lg:px-8">
      <Image
        src="/logo.png"
        alt="YB logo"
        width={300}
        height={300}
        className="absolute top-54 object-contain"
      />
